...
// admin
    ...
    $select_query="SELECT * FROM admin where email='$email'or username='$username'";
...
$query="INSERT INTO admin (fname,lname,username,address,phnum,email,password) values('$fname','$lname','$username','$address','$phnum','$email','$password')";
