...
if($page>1)
{
    echo '<a href="qna.php?page='.($page-1).'" class="prev-btn">Previous</a>';
}
for($i=1; $i<5; $i++)
{
    echo '<a href="qna.php?page='.$i.'" class="page-btn">'.$i.'</a>';
}
if($page<$tpage)
{
    echo '<a href="javascript:arry();" class="next-btn"><input type="submit" name="next" value="Next"></a>';
} 
?>
</div>     
</form>
...
for(var i= page; i<tpage; i++)
{
    const question[i]=questiontop;
    const answer[i]=answertop;
    alert(question[i]);
    alert (answer[i]);
}
}
